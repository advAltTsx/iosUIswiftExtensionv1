    ...
    >
      ...
      <DrawerContent>
        <div className="min-h-[70vh] h-auto px-6">
         ...
         <br/>
              <DrawerDescription>Also, the new feature, {"don't"} use arrows like a kid, scroll right away like an insta reel, yt short instead. It took time to build with framer motion, gotta flex 💪</DrawerDescription>
            </div>
          </DrawerHeader>
