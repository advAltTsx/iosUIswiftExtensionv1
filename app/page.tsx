                  ...
                  <div className="min-h-[70vh] h-auto">
                    <DrawerHeader>
                      <div className="flex flex-col justify-center px-4 text-center h-full my-10">
                        ...
                        <DrawerDescription>
                          {
                            "No worries, this time we meet IRL, I'll hand over a unique code of 8 letters (share it with only your classmates), for our private conversation, and the path goes like"
                          }
                        </DrawerDescription>
